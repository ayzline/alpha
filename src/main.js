...
const myBott = ['u295662d3d8c1f0a3df34c736a3db3072','ucfc8d6cd1218716c76529f007f3e0546'];//TARO MID LU DISINI SUPAYA BISA PKE COMMAND STAFF

const myBot = ['u295662d3d8c1f0a3df34c736a3db3072','ucfc8d6cd1218716c76529f007f3e0546'];//TARO MID LU DISINI
...
let { listMember } = await this.searchGroup(seq.to);
     const mentions = await this.mention(listMember);
        ...
        if(txt == 'creator') {
           this._sendMessage(seq, 'My Creator Is Bee\nId Line : http://line.me/ti/p/~ayzline.\n\n-Ayz-');
           seq.contentType=13;
           seq.contentMetadata = { mid: 'u295662d3d8c1f0a3df34c736a3db3072' };
           this._client.sendMessage(1, seq);
        }
        ...
        if(txt == 'bye') {
           if(!isAdminOrBot(seq.from) || !isStaffOrBot(seq.from)){
          let txt = await this._sendMessage(seq, 'Terima Kasih Atas Groupnya Dan Kami Izin Leave~');
